...
import com.example.jollycat.databinding.ActivityCatsDetailPageBinding

class ActivityCatsDetailPage : AppCompatActivity() {
    private lateinit var binding: ActivityCatsDetailPageBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCatsDetailPageBinding.inflate(layoutInflater)
        ...
        if (cat != null) {
            binding.detailCatDescTV.text = cat.catDescription
            binding.detailCatPriceTV.text = "Rp " + cat.catPrice
